<div class="modal fade" id="myModalAjoutDescL">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-header px-2 pt-3 pb-1">
                <h4 class="modal-title pl-3">Description longue</h4>
            ...
            <div class="modal-body py-0">
                <form action="index.php" method="post">
                    <input type="hidden" name="p" value="upDescL">
                    <input type="hidden" name="id" value=<?php echo $recette[0]->ID; ?>>
                    <textarea name="desc" type="text" placeholder="Description longue de la recette"></textarea>
