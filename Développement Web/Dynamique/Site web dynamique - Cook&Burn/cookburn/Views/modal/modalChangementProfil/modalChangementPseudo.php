<div class="modal fade" id="myModalChgPseudo">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-header px-2 pt-3 pb-1">
                <h4 class="modal-title pl-3">Changer Pseudo</h4>
            ...
            <div class="modal-body py-0">
                <form action="index.php" method="post">
                    <input type="hidden" name="p" value="chgPseudo">
                    <input name="pseudo" type="text" class="form-control form-control-sm pl-2 pt-1 mb-1" placeholder="Nouveau Pseudo">
